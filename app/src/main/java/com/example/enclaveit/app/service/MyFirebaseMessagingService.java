...
import com.example.enclaveit.app.activities.ActivityMain;
 ...
 *
 * > When data type message is sent, handleDataMessage() method is used to handle the payload irrespective of app state
 * (foreground / background).
 *
 * > LocalBroadcastManager is used to broadcast the message to all the activities which are registered for the broadcast
 * receiver.
 */
